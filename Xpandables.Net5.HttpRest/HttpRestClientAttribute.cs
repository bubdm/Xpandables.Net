                ...
                switch (BodyFormat)
                {
                    ...
                    case BodyFormat.Multipart:
                        ...
                        if (multipartSource.GetStringContent() is { } mstringContent)
                            multipartContent.Add(new StringContent(JsonConvert.SerializeObject(mstringContent), Encoding.UTF8, ContentType));
                    ...
                    case BodyFormat.String:
                        ...
                        httpRequestMessage.Content = new StringContent(JsonConvert.SerializeObject(source), Encoding.UTF8, ContentType);
                        break;
                }
