...
using static Xpandables.Net5.HttpRest.HttpRestClientHelpers;
...
#pragma warning restore CA1031 // Do not catch general exception types
               ...
               Func<Exception, HttpStatusCode, HttpRestClientResponse> responseBuilder, HttpResponseMessage httpResponse)
        {
            ...
            {
                { } => await GetBadResponseContentAsync(),
            ...
            {
                var stream = await httpResponse.Content.ReadAsStreamAsync().ConfigureAwait(false);
                var content = await stream.StreamToStringAsync().ConfigureAwait(false);
