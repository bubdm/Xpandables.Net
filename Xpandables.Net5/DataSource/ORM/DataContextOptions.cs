...
namespace System.Design.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Enables seeder for the data context that is decorated with <see cref="IBehaviorDataSeed"/>.
        /// </summary>
        ...
        {
            if (persistenceExceptionHandler is null) throw new ArgumentNullException(nameof(persistenceExceptionHandler));
