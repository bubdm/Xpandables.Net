...
namespace System.Design
{
    ...
    /// In order to control the behavior, you can add the <see cref="IBehaviorCorrelation"/> to the commad/query class and reference
    ...
    /// <see cref="ServiceCollectionExtensions.AddXPersistenceBehavior(IServiceCollection)"/>,
    /// register the data context using the <see cref="ServiceCollectionExtensions.AddXDataContext{TDataContextProvider}(IServiceCollection)"/> extension method
    /// or <see cref="ServiceCollectionExtensions.AddXCommandQueriesHandlers(IServiceCollection, Action{CommandQueryOptions}, Reflection.Assembly[])"/>
    /// extension method.
    /// <para></para>
