...
namespace System
{
    ...
    public static class DataBaseHelpers
    {
        ...
        public static async Task<int> ExecuteTransactionAsync(this DataBaseContext dataBase, string sqlQuery, params object[] parameters)
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="sqlQuery"/> is null.</exception>
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<DataTable> ExecuteQueryTableAsync(this DataBaseContext dataBase, string sqlQuery, params object[] parameters)
        ...
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<DataTable> ExecuteProcedureTableAsync(this DataBaseContext dataBase, string storedProc, params object[] parameters)
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="sqlQuery"/> is null.</exception>
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<T?> ExecuteQueryAsync<T>(this DataBaseContext dataBase, string sqlQuery, params object[] parameters)
            where T : class, new()
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="sqlQuery"/> is null.</exception>
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<List<T>> ExecuteQueriesAsync<T>(this DataBaseContext dataBase, string sqlQuery, params object[] parameters)
            where T : class, new()
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="storedProc"/> is null.</exception>
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<int> ExecuteProcedureAsync(this DataBaseContext dataBase, string storedProc, params object[] parameters)
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="storedProc"/> is null.</exception>
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<List<T>> ExecuteProceduresAsync<T>(this DataBaseContext dataBase, string storedProc, params object[] parameters)
            where T : class, new()
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="sqlQuery"/> is null.</exception>
        /// <exception cref="InvalidOperationException">the execution failed. See inner exception.</exception>
        public static async Task<T> ExecuteSingleAsync<T>(this DataBaseContext dataBase, string sqlQuery, params object[] parameters)
