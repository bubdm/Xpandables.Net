...
namespace System.Design
{
    ...
    /// <see cref="ServiceCollectionExtensions.AddXValidatorRuleBehavior(IServiceCollection)"/>
    /// for the validation behavior and <see cref="ServiceCollectionExtensions.AddXValidatorRules(IServiceCollection, Reflection.Assembly[])"/>
    /// to register all your custom implementations or use the
