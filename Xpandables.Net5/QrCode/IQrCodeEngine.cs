...
namespace System.Design.QrCode
{
    ...
    /// </summary>
    public interface IQrCodeEngine
    {
        /// <summary>
        ...
        IQrCodeEngine UseTextGenerator(IQrCodeTextGenerator newTextGeneratorService);
        ...
        IQrCodeEngine UseImageGenerator(IQrCodeImageGenerator newImageGeneratorService);
        ...
        IQrCodeEngine UseValidator(IQrCodeValidator newValidatorService);
