...
using static Xpandables.Net5.QrCodes.Presenter.Base64QrCode;
using static Xpandables.Net5.QrCodes.Presenter.QRCodeGenerator;
using static Xpandables.Net5.QrCodes.Presenter.SvgQRCode;
...
namespace Xpandables.Net5.QrCodes
{
    ...
    public static class QrCodeHelpers
    {
        ...
        public static byte[] ToByte(this Bitmap image) => image.ToByte(ImageFormat.Jpeg);
        ...
        public static byte[] GetPngByteQrCode(string txt, ECCLevel eccLevel, int size)
        {
        ...
        /// <param name="eccLevel"></param>
        /// <param name="size"></param>
        public static byte[] GetBitmapByteQrCode(string txt, ECCLevel eccLevel, int size)
        {
            using var qrGen = new QRCodeGenerator();
            using var qrCode = qrGen.CreateQrCode(txt, eccLevel);
