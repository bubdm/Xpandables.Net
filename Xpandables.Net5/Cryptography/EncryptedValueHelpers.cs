...
{
    /// <summary>
    /// Provides with helper methods for <see cref="EncryptedValue"/>.
    /// </summary>
    public static class EncryptedValueHelpers
    {
        /// <summary>
        ...
        /// <returns>An encrypted object that contains the encrypted value and its key.</returns>
        /// <exception cref="ArgumentNullException">The <paramref name="source"/> is null.</exception>
        public static EncryptedValue Encrypt(this string source)
        {
        ...
        public static bool IsEqualTo(this EncryptedValue encrypted, string value)
        {
