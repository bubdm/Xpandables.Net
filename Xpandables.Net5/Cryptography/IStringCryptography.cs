...
namespace System.Design.Cryptography
{
    ...
    public interface IStringCryptography
    {
        ...
        EncryptedValue EncryptShort(string value, int keySize = 12);
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="value"/> is null.</exception>
        /// <exception cref="InvalidOperationException">The encryption failed. See inner exception.</exception>
        EncryptedValue Encrypt(string value, string? key = default, string? salt = default);
        ...
        string Decrypt(string key, string value, string salt) => Decrypt(new EncryptedValue(key, value, salt));
        ...
        bool AreEqual(EncryptedValue encrypted, string value)
        {
