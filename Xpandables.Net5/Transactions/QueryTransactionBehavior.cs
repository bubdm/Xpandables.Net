...
namespace System.Design.Behaviors
{
    ...
    /// provide an implementation and use the extension method <see cref="ServiceCollectionExtensions.AddXTransactionBehavior(Microsoft.Extensions.DependencyInjection.IServiceCollection, Type)"/>
    /// for registration. The transaction scope definition comes from the
    /// <see cref="ITransactionScopeProvider.GetTransactionScope{TArgument}(TArgument)"/> method.
