...
namespace System.Design.Behaviors
{
    ...
    public sealed class CommandTransactionBehavior<TCommand> : ICommandHandler<TCommand>
        where TCommand : class, ICommand, IBehaviorTransaction
    {
        ...
        public CommandTransactionBehavior(ICommandHandler<TCommand> decoratee, ITransactionScopeProvider transactionScopeProvider)
        {
