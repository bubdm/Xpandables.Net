...
namespace System.Design.Behaviors
{
    ...
    /// provide an implementation and use the extension method <see cref="ServiceCollectionExtensions.AddXIdentityBehavior(Microsoft.Extensions.DependencyInjection.IServiceCollection, Type)"/>
