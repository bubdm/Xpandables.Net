    ...
    public static class TypeHelpers
    {
            ...
            object[]? args)
        {
            ...
            try
            {
                ...
                if (result is null)
                {
                    invokeException = new ArgumentNullException("No result !");
                    return false;
                }
            ...
            [NotNullWhen(false)] out Exception? typeException)
        {
            ...
            try
            {
                ...
                if (type is null)
                {
                    typeException = new ArgumentNullException("Type not found.");
                    return false;
                }
                return true;
            }
            ...
            params Type[] parameterTypes)
        {
            ...
            try
            {
                ...
                {
                    constructorException = new ArgumentNullException("Constructor not found.");
                    return false;
                }
                return true;
            }
        ...
        {
            _ = type ?? throw new ArgumentNullException(nameof(type));
            return TypeNameHelpers.GetTypeDisplayName(type, includeGenericParameterNames: true);
        }
