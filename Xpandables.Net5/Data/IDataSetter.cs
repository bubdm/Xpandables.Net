...
namespace Xpandables.Net5.Data
{
    ...
    public interface IDataSetter
    {
        ...
        void SetData(IDataRecord dataRecord, object entity, IInstanceCreator instanceCreator);
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        void SetData(DataRow dataRow, object entity, IInstanceCreator instanceCreator);
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        void SetData(object value, object entity, IInstanceCreator instanceCreator);
    }
        ...
        where T : class
    {
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        void SetData(IDataRecord dataRecord, T entity, IInstanceCreator instanceCreator);
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        void SetData(DataRow dataRow, T entity, IInstanceCreator instanceCreator);
    }
}
