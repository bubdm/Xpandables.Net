...
namespace Xpandables.Net5.Data
{
    ...
    public class DataProperty : IDataSetter
    {
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        public void SetData(DataRow dataRow, object entity, IInstanceCreator instanceCreator)
        {
            ...
            {
                SetData(dataRow[DataFullName], entity, instanceCreator);
            }
        }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        public void SetData(IDataRecord dataRecord, object entity, IInstanceCreator instanceCreator)
        {
            ...
            if (dataRecord.Contains(DataFullName))
            {
                ...
                if (!dataRecord.IsDBNull(index))
                    SetData(dataRecord.GetValue(index), entity, instanceCreator);
            }
        }
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity" /> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator" /> is null.</exception>
        public void SetData(object value, object entity, IInstanceCreator instanceCreator)
        {
        ...
        where T : class, new()
    {
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        public void SetData(DataRow dataRow, T entity, IInstanceCreator instanceCreator) => base.SetData(dataRow, entity, instanceCreator);
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="entity"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="instanceCreator"/> is null.</exception>
        public void SetData(IDataRecord dataRecord, T entity, IInstanceCreator instanceCreator) => base.SetData(dataRecord, entity, instanceCreator);
