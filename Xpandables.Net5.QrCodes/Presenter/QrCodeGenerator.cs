...
namespace Xpandables.Net5.QrCodes.Presenter
{
    /// <summary>
    /// The QrCode generator class.
    /// </summary>
    public class QRCodeGenerator : Disposable
    {
...
#pragma warning restore CA1822 // Mark members as static
        ...
        {
            _ = binaryData ?? throw new ArgumentNullException(nameof(binaryData));
...
#pragma warning restore CS8605 // Conversion unboxing d'une valeur peut-être null.
        ...
        private static int GetVersion(int length, EncodingMode encMode, ECCLevel eccLevel)
        {
            ...
            throw new QrCodeException(eccLevel.ToString(), encMode.ToString(), maxSizeByte);
        }
        ...
        private static bool IsValidISO(string input)
        {
            ...
            return string.Equals(input, result, StringComparison.InvariantCulture);
        }

        private static string PlainTextToBinary(string plainText, EncodingMode encMode, EciMode eciMode, bool utf8BOM, bool forceUtf8) => encMode switch
        {
