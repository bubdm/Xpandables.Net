...
{
    /// <summary>
    /// Represents a notification event entity to be written.
    /// </summary>
    [Table(nameof(NotificationEvents))]
    public sealed class NotificationEventStoreEntity : EventStoreEntity
    {
        /// <summary>
        /// For internal use.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="NotificationEventStoreEntity"/> with the specified properties.
        /// </summary>
