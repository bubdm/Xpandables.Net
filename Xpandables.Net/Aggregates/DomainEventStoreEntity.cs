...
{
    /// <summary>
    /// Represents a domain event entity to be written.
    /// </summary>
    [Table(nameof(DomainEvents))]
    public sealed class DomainEventStoreEntity : EventStoreEntity
    {
        /// <summary>
        /// For internal use.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="DomainEventStoreEntity"/> with the specified properties.
        /// </summary>
