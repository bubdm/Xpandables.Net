...
{
    /// <summary>
    /// Represents a snapshot entity to be written.
    /// </summary>
    [Table("SnapShotEvents")]
    public sealed class SnapShotStoreEntity : EventStoreEntity
    {
        /// <summary>
        /// For internal use.
        /// </summary>
        ...
        /// <summary>
        /// Constructs a new instance of <see cref="SnapShotStoreEntity"/> with the specified properties.
        /// </summary>
