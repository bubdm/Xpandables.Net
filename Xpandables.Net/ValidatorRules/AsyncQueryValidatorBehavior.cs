...
namespace Xpandables.Net.ValidatorRules
{
    ...
    public sealed class AsyncQueryValidatorBehavior<TQuery, TResult> : IAsyncQueryHandler<TQuery, TResult>
        where TQuery : class, IAsyncQuery<TResult>, IBehaviorValidation
    {
        private readonly IAsyncQueryHandler<TQuery, TResult> _decoratee;
        private readonly ICompositeValidatorRule<TQuery> _validator;

        /// <summary>
        /// Initializes a new instance of <see cref="AsyncQueryValidatorBehavior{TQuery, TResult}"/>.
        /// </summary>
        ...
        public AsyncQueryValidatorBehavior(IAsyncQueryHandler<TQuery, TResult> decoratee, ICompositeValidatorRule<TQuery> validator)
        {
