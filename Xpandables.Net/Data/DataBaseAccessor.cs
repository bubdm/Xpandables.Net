...
{
    /// <summary>
    /// Provides methods to access the <see cref="DataBase"/>.
    /// </summary>
    public sealed class DataBaseAccessor
    {
        private readonly IDataProviderFactoryProvider _dataProviderFactoryProvider;
        private readonly IDataConnectionAccessor _dataConnectionAccessor;

        /// <summary>
        /// Initializes a new instance of <see cref="DataBaseAccessor"/> with collection of settings.
        /// </summary>
        ...
        public DataBaseAccessor(IDataConnectionAccessor dataConnectionAccessor, IDataProviderFactoryProvider dataProviderFactoryProvider)
        {
        ...
        /// You can use the <see cref="IDataConnectionAccessor"/> to find the available settings.
        /// </summary>
        ...
        public DataBase GetDataBaseContext(string poolName)
        {
        ...
        public DataBase GetDataBaseContext(DataConnection connection) => new DataBase(_dataProviderFactoryProvider, connection);
        ...
        public object? GetService(Type serviceType) => _dataProviderFactoryProvider.GetService(serviceType);
    }
}
