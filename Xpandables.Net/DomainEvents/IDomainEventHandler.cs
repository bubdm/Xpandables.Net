...
namespace Xpandables.Net.DomainEvents
{
    ...
    public interface IDomainEventHandler : ICanHandle
    {
        ...
        /// <exception cref="ArgumentException">The <paramref name="domainEvent"/> does not implement <see cref="IDomainEvent"/>.</exception>
        ...
        where TEvent : class, IDomainEvent
    {
        ...
        Task IDomainEventHandler.HandleAsync(object domainEvent, CancellationToken cancellationToken)
        {
            ...
            throw new ArgumentException($"The parameter does not implement {nameof(IDomainEvent)} interface.", nameof(domainEvent));
        }
    }
}
