...
namespace Xpandables.Net.Entities
{
    ...
    public abstract class Aggregate : OperationResultBase, IAggregate, IAggregateEventSourcing, IAggregateOutbox
    {
        ...
        void IAggregateEventSourcing.LoadFromHistory(IOrderedEnumerable<IDomainEvent> events)
        {
        ...
        void IAggregateEventSourcing.LoadFromHistory(IDomainEvent @event)
        {
        ...
        void IAggregateEventSourcing.Mutate(IDomainEvent @event)
        {
            _ = @event ?? throw new ArgumentNullException(nameof(@event));
            ...
            where TEvent : class, IDomainEvent
        {
            ...
            ((IAggregateEventSourcing)this).Apply(@event);
        }
