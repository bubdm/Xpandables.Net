...
using Xpandables.Net.DependencyInjection.Registrations.Interfaces;
using Xpandables.Net.Helpers;

namespace Xpandables.Net.DependencyInjection.Registrations.Internals
{
    ...
    internal static class Helpers
    {
        ...
        public static IEnumerable<Type> FindMatchingInterface(this TypeInfo typeInfo, Action<TypeInfo, IImplementationTypeFilter>? action)
        {
            ...
            else
            {
                ...
                action(typeInfo, (IImplementationTypeFilter)filter);
