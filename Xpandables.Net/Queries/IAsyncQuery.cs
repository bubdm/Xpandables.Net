...
namespace Xpandables.Net.Queries
{
    ...
    /// <para>Class implementation is used with the <see cref="IAsyncQueryHandler{TQuery, TResult}"/> where
    /// "TQuery" is <see cref="IAsyncQuery{TResult}"/> class implementation.</para>
