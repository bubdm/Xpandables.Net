...
namespace Xpandables.Net.Identities
{
    ...
    public sealed class QueryIdentityDecorator<TQuery, TResult> : IQueryHandler<TQuery, TResult>
        where TQuery : class, IIdentityData, IQuery<TResult>, IIdentityDecorator
    {
        private readonly IIdentityDataProvider _identityDataProvider;
        private readonly IQueryHandler<TQuery, TResult> _decoratee;

        /// <summary>
        /// Initializes a new instance of <see cref="QueryIdentityDecorator{TQuery, TResult}"/>.
        /// </summary>
        ...
        public QueryIdentityDecorator(IIdentityDataProvider identityProvider, IQueryHandler<TQuery, TResult> decoratee)
        {
