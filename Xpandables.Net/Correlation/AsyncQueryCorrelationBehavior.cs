...
namespace Xpandables.Net.Correlation
{
    ...
    public sealed class AsyncQueryCorrelationBehavior<TQuery, TResult> : IAsyncQueryHandler<TQuery, TResult>
        where TQuery : class, IAsyncQuery<TResult>, IBehaviorCorrelation
    {
        private readonly IAsyncQueryHandler<TQuery, TResult> _decoratee;
        private readonly CorrelationContext _correlationContext;

        /// <summary>
        /// Initializes a new instance of <see cref="AsyncQueryCorrelationBehavior{TQuery, TResult}"/> class.
        /// </summary>
        ...
        public AsyncQueryCorrelationBehavior(CorrelationContext correlationContext, IAsyncQueryHandler<TQuery, TResult> decoratee)
        {
