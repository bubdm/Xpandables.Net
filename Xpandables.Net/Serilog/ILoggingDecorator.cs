...
namespace Xpandables.Net.Serilog
{
    ...
    /// You need to register the expected behavior using the appropriate add data log context extension method and provide an implementation of <see cref="ILoggerEngine"/>.
    /// </summary>
