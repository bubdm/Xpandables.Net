...
namespace Xpandables.Net.Serilog
{
    ...
    public sealed class AsyncCommandLoggingDecorator<TCommand> : IAsyncCommandHandler<TCommand>
        where TCommand : class, IAsyncCommand, ILoggingDecorator
    {
        private readonly IAsyncCommandHandler<TCommand> _decoratee;
        private readonly ILoggerEngine _logger;

        /// <summary>
        /// Initializes a new instance of <see cref="AsyncCommandLoggingDecorator{TCommand}"/> class with the logger and the command handler to be decorated.
        /// </summary>
        ...
        public AsyncCommandLoggingDecorator(ILoggerEngine logger, IAsyncCommandHandler<TCommand> decoratee)
        {
