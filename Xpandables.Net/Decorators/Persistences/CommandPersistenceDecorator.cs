...
namespace Xpandables.Net.Decorators.Persistences
{
        ...
        where TCommand : class, ICommand, IPersistenceDecorator
    {
        ...
        public CommandPersistenceDecorator(IDataContext context, ICommandHandler<TCommand> decoratee)
        {
        ...
        where TCommand : class, ICommand<TResult>, IPersistenceDecorator
    {
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="decoratee"/> is null.</exception>
        /// <exception cref="ArgumentNullException">The <paramref name="context"/> is null.</exception>
        public CommandPersistenceDecorator(IDataContext context, ICommandHandler<TCommand, TResult> decoratee)
        {
            _context = context ?? throw new ArgumentNullException(nameof(context));
            _decoratee = decoratee ?? throw new ArgumentNullException(nameof(decoratee));
        }
