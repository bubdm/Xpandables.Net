...
namespace Xpandables.Net.Decorators.Persistences
{
    ...
    public sealed class AggregateNotificationPersistenceDecorator<TAggregateId, TNotification>
        : PersistenceDecoratorBase, INotificationEventHandler<TAggregateId, TNotification>
        where TNotification : class, INotificationEvent<TAggregateId>, IAggregatePersistenceDecorator
        where TAggregateId : notnull, IAggregateId
    {
        private readonly INotificationEventHandler<TAggregateId, TNotification> _decoratee;

        /// <summary>
        /// Initializes a new instance of the <see cref="AggregateNotificationPersistenceDecorator{TAggregateId, TNotification}"/> class with
        ...
        public AggregateNotificationPersistenceDecorator(IDomainEventDataContext dataContext, INotificationEventHandler<TAggregateId, TNotification> decoratee)
            : base(dataContext)
