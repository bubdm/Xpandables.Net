...
{
    /// <summary>
    /// The <see cref="IDisposable.Dispose"/> method ends the scope lifetime. Once Dispose is called, any scoped <typeparamref name="TService"/>s that have been resolved from <see cref="IServiceScope{TService}"/> will be disposed.
    /// </summary>
