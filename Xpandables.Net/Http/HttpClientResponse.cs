...
/// </summary>
public class HttpClientResponse : Disposable
{
    /// <summary>
    /// Returns a success HTTP status response.
    /// </summary>
    /// <param name="statusCode">The status code of the response.</param>
    internal static HttpClientResponse Success(HttpStatusCode statusCode = HttpStatusCode.OK)
        => new(statusCode);
    ...
    internal static HttpClientResponse Failure(Exception exception, HttpStatusCode statusCode = HttpStatusCode.BadRequest)
    ...
    /// </summary>
    /// <param name="statusCode">The status code of the response.</param>
    internal static HttpClientResponse Failure(HttpStatusCode statusCode = HttpStatusCode.BadRequest)
        => new(statusCode);

    /// <summary>
    /// Initializes a new instance of <see cref="HttpClientResponse"/> class with the status code.
    /// </summary>
    /// <param name="statusCode">The status code of the response.</param>
    protected HttpClientResponse(HttpStatusCode statusCode) => StatusCode = statusCode;
    ...
    /// <param name="statusCode">The status code of the response.</param>
    /// <exception cref="ArgumentNullException">The <paramref name="exception"/> is null.</exception>
    protected HttpClientResponse(HttpClientException exception, HttpStatusCode statusCode = HttpStatusCode.BadRequest)
    {
    ...
    /// <param name="statusCode">The status code of the response.</param>
    /// <exception cref="ArgumentNullException">The <paramref name="exception"/> is null.</exception>
    protected HttpClientResponse(Exception exception, HttpStatusCode statusCode)
    {
    ...
    /// </summary>
    public HttpClientException? Exception { get; protected set; }
    ...
    internal HttpClientResponse AddReasonPhrase(string? reason) => this.With(h => h.ReasonPhrase = reason);

    /// <summary>
    /// Adds the response headers.
    /// </summary>
    /// <param name="headers">the headers to be used.</param>
    internal HttpClientResponse AddHeaders(NameValueCollection headers)
    {
    ...
    internal HttpClientResponse AddVersion(Version version) => this.With(h => h.Version = version);
}
...
public class HttpRestClientResponse<TResult> : HttpClientResponse
{
    /// <summary>
    /// Converts the current <see cref="HttpClientResponse"/> to the generic of <typeparamref name="TTarget"/> type.
    /// </summary>
    ...
    internal static HttpRestClientResponse<TResult> Failure(
        HttpClientException exception, HttpStatusCode statusCode = HttpStatusCode.BadRequest)
        => new(exception, statusCode);
    ...
    /// <param name="statusCode">The status code of the response.</param>
    /// <exception cref="ArgumentNullException">The <paramref name="exception"/> is null.</exception>
    protected HttpRestClientResponse(HttpClientException exception, HttpStatusCode statusCode)
