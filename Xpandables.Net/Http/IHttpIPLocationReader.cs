...
/// <summary>
/// Provides with a method to read IP Geo-location using a typed client HTTP Client.
/// </summary>
public interface IHttpIPLocationReader
{
    /// <summary>
    ...
    Task<HttpRestClientResponse<IPLocationResponse>> ReadLocationAsync(
...
/// </summary>
public class IPLocationRequest : IHttpClientRequest<IPLocationResponse>, IHttpClientQueryStringLocationRequest, IHttpClientAttributeProvider
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IPLocationRequest"/> class with IP address to locate.
    /// </summary>
    ...
    /// <summary>
    /// Returns the <see cref="HttpClientAttribute" /> to be applied on the current instance.
    /// </summary>
    public HttpClientAttribute ReadHttpClientAttribute()
        => new()
        {
            Path = IpAddress,
            IsNullable = true,
...
/// <summary>
/// Defines the IP Address Geo-location response.
/// </summary>
