...
namespace Xpandables.Net.HttpRestClient
{
    ...
    /// <see cref="HttpClientFactoryServiceCollectionExtensions.AddHttpClient{TClient, TImplementation}(IServiceCollection)"/> and you may add 
    /// <see cref="HttpClientBuilderExtensions.ConfigureHttpClient(IHttpClientBuilder, Action{HttpClient})"/> or other 
