...
{
    /// <summary>
    /// Class helper to implement <see cref="IAddServiceExportExtended"/>.
    ...
    /// </summary>
    public abstract class AddServiceExportExtended : IAddServiceExportExtended
    {
        /// <summary>
        ...
        public void AddServices(object services, object configuration) => AddServices((IServiceCollection)services, (IConfiguration)configuration);
