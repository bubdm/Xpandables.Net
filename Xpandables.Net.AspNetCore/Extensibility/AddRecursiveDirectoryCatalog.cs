...
namespace Xpandables.Net.Extensibility
{
    ...
    /// </summary>
    public sealed class UseRecursiveDirectoryCatalog : ComposablePartCatalog, INotifyComposablePartCatalogChanged, ICompositionElement
    {
        private readonly AggregateCatalog _aggregateCatalog = new();
        private readonly string _path;

        /// <summary>
        /// Initializes a new instance of the <see cref="UseRecursiveDirectoryCatalog"/> class with <see cref="ComposablePartDefinition"/> objects based
        ...
        public UseRecursiveDirectoryCatalog(string path) : this(path, "*.dll") { }

        /// <summary>
        /// Initializes a new instance of the <see cref="UseRecursiveDirectoryCatalog"/> class with <see cref="ComposablePartDefinition"/> objects based on
        ...
        public UseRecursiveDirectoryCatalog(string path, string searchPattern)
        {
