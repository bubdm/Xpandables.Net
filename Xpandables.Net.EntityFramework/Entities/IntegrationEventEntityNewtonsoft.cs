...
namespace Xpandables.Net.EntityFramework.Entities
{
    ...
    /// </summary>
    public class IntegrationEventEntityNewtonsoft : IntegrationEventEntity
    {
        /// <summary>
        /// Constructs anew instance of <see cref="IntegrationEventEntityNewtonsoft"/> from the specified event.
        /// </summary>
        /// <param name="event">The event to act with.</param>
        /// <exception cref="ArgumentNullException">The <paramref name="event"/> is null.</exception>
        public IntegrationEventEntityNewtonsoft(IIntegrationEvent @event) : base(@event) { }
